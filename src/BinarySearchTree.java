...
public class BinarySearchTree extends BinaryTree
{
    ...
    public WordADT search(WordADT searchItem)
    {
        BinaryTreeNode current;
        boolean found = false;
        WordADT word = new Word("The word could not be found.","");
    ...
    public boolean insert(WordADT insertItem)
    {
       ...
       //               search tree.    
    public boolean deleteNode(WordADT deleteItem)
    {
        BinaryTreeNode current = null;  //reference variable to 
                                  //traverse the tree
        BinaryTreeNode trailCurrent = null; //reference variable 
                                      //behind current
        boolean found = false;
